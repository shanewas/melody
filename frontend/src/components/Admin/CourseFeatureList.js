...
export default function CourseFeatureList() {
  ...
  //get all courses list from server later it will be list of all featured courses
  function getCourses() {
    axios
      .get("course/", {
        headers: {
  ...
  return (
    ...
    >
      <Grid item>{customList("Courses", left)}</Grid>
      <Grid item>
      ...
      <Grid item>{customList("Featured Courses", right)}</Grid>
    </Grid>
  );
}
